...
class Evaluator:
    ...
    def __init__(self, desired_metric, real_annotation, pred_annotation,
                 missing_data_array, performance_array):
        ...
        self.missing_data_array = missing_data_array
        self.performance_array = performance_array
        # #Set metrics.
    ...
    def plot_performance(self):
        ...
        perf_ax.plot(self.missing_data_array, self.performance_array)
